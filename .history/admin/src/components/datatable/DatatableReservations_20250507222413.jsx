...
const Datatable = () => {
  ...
  const confirmFinishClick = async () => {
    ...
    try {
      ...
      // ✅ Buscar el registro de Accounting existente
      const { data: existingAccounting } = await axiosInstance.get(`/accounting/by-lodge/${bookingId}`);
