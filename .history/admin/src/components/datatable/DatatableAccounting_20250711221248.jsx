...
const actionColumn = [
  {
    ...
    renderCell: (params) => {
      ...
      const paymentCanceled = params.row.status === "686f099aacd6f16c7fd3c905"
      ...
      return (
        <div className="cellAction">
          ...
          {(!isLodgeCanceled && !(params.row.status === "686f099aacd6f16c7fd3c905")) && (
          ...
          {(isLodgeCanceled && !showReturnButton) && (
            <div
