  ...
  const userColumns = [
    {
        ...
        headerName: "Cliente",
        width: 150,
        valueGetter: (params) => params.row.user?.name || "N/A" // Cambia `name` al campo correcto si es distinto
    },
    {
        field: "entity",
        headerName: "Entidad",
        width: 150,
        valueGetter: (params) => {
            if (params.row.lodge) return params.row.lodge.name || "Cabaña"; // Cambia `name` al campo correcto si es distinto
  ...
  return (
    <div className="datatable">
      ...
      <DataGrid
        className="datagrid"
        rows={data}
        columns={[...userColumns, ...userColumns, ...actionColumn]}
        pageSize={9}
