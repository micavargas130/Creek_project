...
const Datatable = (props) => {
 ...
 const closeDialog = () => {
  ...
  const handleCommentSubmit = (params) => {
    ...
    try {
        axios.put(`http://localhost:3000/accounting//${params.row._id}comment`, {
  ...
  const handleStatusChange = (params) => {
    try {
     ...
     axios.post(`http://localhost:3000/accounting/${params.row._id}/status`, {status: selectedStatus.status});
    ...
    <div className="datatable">
      ...
      <Dialog open={isStatusDialogOpen} onClose={closeStatusOptions}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleStatusChange} color="primary">Guardar</Button>
        </DialogActions>
      </Dialog>
