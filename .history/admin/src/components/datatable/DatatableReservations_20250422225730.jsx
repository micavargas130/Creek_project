...
const Datatable = () => {
  const { data, loading, error, ref } = useFetch("/bookings");
  ...
  useEffect(() => {
    ...
    globalObserver.subscribe("reservationChange", onReservationChange);
  
    return () => {
      globalObserver.unsubscribe("reservationChange", onReservationChange);
    };
  }, [refetch]);
