...
const Datatable = (props) => {
  ...
  const handleOptionSelect = (option, params) => {
    ...
    if (option === "desocupado") {
      ...
      console.log("status",params.row.state.status); 
    }
      ...
      renderCell: (params) => {
        ...
        const handleCancelClick = async () => {
          try {
            ...
            if(params.row.state.status === "ocupado"){alert("No se puede eliminar una cabaña ocupada")}
            else {
        ...
        return (
          <div className="cellAction">
            { params.row.state.status === "ocupado" && (
          ...
          <div className="stateButton" onClick={(event) => handleMenuClick(event, params.row._id)}> Cambiar estado
  </div>
</Tooltip>
