...
import commentDialog from "C:\Users\Usuario\Desktop\Creek_project\admin\src\components\props\openDialog.jsx
    ...
    renderCell: (params) => {
      ...
      return (
        <div className="cellAction">
          ...
          {isLodgeCanceled && (   
           <div title="La reserva vinculada a este registo fue cancelada" className="deleteButton" onClick={handleCancelClick}>⚠️Devolución</div>            
          )}
        </div>
      );
    },
