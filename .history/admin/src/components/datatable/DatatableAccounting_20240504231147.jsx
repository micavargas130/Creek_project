...
const Datatable = (props) => {
  ...
  <div className="bars">
    <div className="bar">
      <div className="bar-value" style={{ height: `${(getTotalMoney(data) / Math.max(getIncomes(data), getExpenses(data))) * 100}%` }}></div>
      <div className="bar-label">Ingresos: {getIncomes(data)}</div>
    </div>
    <div className="bar">
      <div className="bar-value" style={{ height: `${(getExpenses(data) / Math.max(getIncomes(data), getExpenses(data))) * 100}%` }}></div>
