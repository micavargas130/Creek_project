      ...
      renderCell: (params) => {
        ...
        const handleArrivalClick = async () => {
          try {
            ...
            await axios.put(`/lodges/set-occupied/${params.row.lodge._id}`);
            ...
            console.log("lodgeId",'${params.row.lodge._id}')
            
            // Se linkean los datos de la reserva a la cabaña que reservaron y en donde se van a hospedar
            await axios.put(`/lodges/occupiedBy/${params.row.lodge._id}`, { _id: bookingId });
