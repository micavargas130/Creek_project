...
import accountingObserver from "../../utils/observers/accountingObserver.js";
...
const Datatable = (props) => {
 ...
 const openStatusOptions = (params) => {
  ...
  accountingObserver.subscribe(fetchData);

  return () => {
    accountingObserver.unsubscribe(fetchData); // Limpieza al desmontar
  };
