    ...
    renderCell: (params) => {
      ...
      return (
        <div className="cellAction">
          ...
          {isLodgeCanceled && (
            <><div
              title="La reserva vinculada a este registo fue cancelada"
              style={{ color: "red", fontWeight: "bold", marginRight: "8px" }}
            >⚠️</div>
            <div title="La reserva vinculada a este registo fue cancelada" className="deleteButton" onClick={handleCancelClick}>Borrar</div></>
