  ...
  return (
    ...
    <div className="chartsContainer">
      ...
      <div className="bar-chart">
        <div className="bars">
         <div className="bar income-bar" style={{ height: `${(getExpenses(data) / Math.max(getIncomes(data), getExpenses(data))) * 100}%` }}>
         <div className="bar-label">Ingresos: {getIncomes(data)}</div>
        </div>
         <div className="bar expense-bar" style={{ height: `${(getExpenses(data) / Math.max(getIncomes(data), getExpenses(data))) * 100}%` }}>
         <div className="bar-label">Egresos: {getExpenses(data)}</div>
        </div>
       </div>
      </div>
