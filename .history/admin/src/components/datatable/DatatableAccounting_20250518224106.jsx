...
useEffect(() => {
    ...
    setData(event.detail); // actualiza los datos en el estado
  };
  window.addEventListener("updateAccountingData", handleUpdateEvent); //se subscribe al observer
  return () => {
    window.removeEventListener("updateAccountingData", handleUpdateEvent); //se desubscribe del observer
  };
