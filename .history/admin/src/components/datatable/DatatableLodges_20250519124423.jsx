...
const Datatable = (props) => {
  ...
  lodgeObserver.subscribe("changesLodges", handleStatusChange);
  return () => lodgeObserver.unsubscribe("changesLodges", handleStatusChange);
}, []);
  ...
  const handleMaintenanceSubmit = (params) => {
    try {
      ...
      closeDialog();
      lodgeObserver.notify("cambiosLodges");
    } catch (error) {
