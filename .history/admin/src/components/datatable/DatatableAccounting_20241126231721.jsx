...
const Datatable = (props) => {
 ...
 const openStatusOptions = (params) => {
  setSelectedParams(params);
  setRemainingAmount(params.row.totalAmount - params.row.amountPaid); // Calcula el saldo restante
  ...
  const namesColumns = [
    {
        ...
        headerName: "Cliente",
        width: 150,
        valueGetter: (params) =>(params.row.user?.first_name + " " + params.row.user?.last_name)|| "N/A" // Cambia `name` al campo correcto si es distinto
    },
    {
        field: "entity",
        headerName: "Entidad",
