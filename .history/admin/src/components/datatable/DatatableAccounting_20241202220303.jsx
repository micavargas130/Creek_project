...
const Datatable = () => {
  ...
  async function getPaymentStatusForTent(tentId) {
    try {
        const accountingRecord = await axios.get(`accounting/deloccupiedBy/${params.row._id}`);
            .populate('status') // Obtener el nombre del estado de pago
            .exec();
