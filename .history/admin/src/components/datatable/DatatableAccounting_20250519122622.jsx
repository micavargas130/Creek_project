...
useEffect(() => {
  ...
  const handleAccountingChange = () => {
    console.log("[Observer] Accounting change detectado. Recargando...");
    fetchData();
  };

  accountingObserver.subscribe(handleAccountingChange);

  return () => {
    accountingObserver.unsubscribe(handleAccountingChange);
  };
}, []);
...
accountingObserver.notify();          } catch (error) {
