...
const WidgetsContainer = ({ 
  ...
  return (
    <div className="widgetsContainer">
      {/* Widgets Financieros */}
      <Widget type="totalMoney" totalMoney={totalMoney} onFilterChange={handleFilterChange} />
      <Widget type="totalIncome" totalIncome={totalIncome} onFilterChange={handleFilterChange} />
      <Widget type="totalExpense" totalExpense={totalExpense} onFilterChange={handleFilterChange} />
