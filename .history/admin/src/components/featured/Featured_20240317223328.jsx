...
const Featured = () => {
  ...
  const lodgeState = lodge ? lodge.state : "Desocupada"; // Si no se encuentra la cabaña, se asume que está desocupada
      ...
      <div className="map">
        {Array.from({ length: 8 }, (_, row) => (
          <div key={row} className="map-row">
            ...
            `map-cell ${lodgeState.toLowerCase()}-lodge`; // Agrega una clase según el estado de la cabaña
              ...
              return (
                <div
                  ...
                  } ${lodgeState.toLowerCase()} ${selectedCell.includes(`${row}-${col}`) ? "selected" : ""}`}
