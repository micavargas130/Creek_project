...
const ChartContainer = ({  chartData, totalMoney, totalIncome, totalExpense }) => {
    ...
    const renderChart = () => {
      switch (activeTab) {
        ...
        case "ingresosServicios":
          const filteredRawData = chartData.filter((entry) => {
           if (entry.type !== "Ingreso") return false;
           if (entry.status?.status === "cancelado") return false;
