...
import { UserContext } from "C:/Users\Usuario\Desktop\Creek_project\admin\src\context\UserContext.jsx";
import "./chart.scss";
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        const closedNotifications = JSON.parse(localStorage.getItem(`closedNotifications-${user._id}`)) || [];
    ...
    fetchNotifications();
  }, [user._id]); // Agrega userId como dependencia para re-fetch cuando cambie
