...
// globalObserver.subscribe dentro de otro archivo, por ejemplo observer setup
globalObserver.subscribe("accountingChange", async () => {
  try {
    ...
    window.dispatchEvent(event); // ⬅️ Este evento lo debe escuchar el componente contable
  } catch (error) {
