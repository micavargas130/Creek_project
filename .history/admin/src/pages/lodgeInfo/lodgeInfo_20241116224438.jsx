...
export default function LodgeInfo() {
  ...
  const handleAddPhoto = async () => {
    try {
      ...
      newPhotos.forEach((photo) => uploadFormData.append("photos", photo));
  
      const res = await axios.post(`/lodge/upload`, uploadFormData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
  
      // Actualiza las fotos con las rutas devueltas por el servidor
      const updatedPhotos = [...(formData.photos || []), ...res.data.filePaths];
      ...
      setNewPhotos([]); // Limpia las fotos seleccionadas
    } catch (err) {
