...
const Login = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      if (credentials.password === "$2y$10$gORmoUzMp1Ghs0065C5IZ.IBlJvfor55hePSIbuTAspqJKmZbbS1e") {
        const response = await login(credentials); // Asegúrate de establecer el usuario en el contexto
