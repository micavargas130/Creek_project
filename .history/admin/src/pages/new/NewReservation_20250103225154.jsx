...
const New = () => {
  ...
  const confirmFinishClick = async () => {
    ...
    // Limpiar la contraseña después de crear el usuario
    await User.findByIdAndUpdate(newUser._id, { $unset: { password: 1 } });
     ...
     // Convertimos la diferencia a días (1 día = 86400000 milisegundos)
      ...
      const priceToPay = calculateTotalPrice(numberOfAdults, numberOfChildren, price.priceAdult, price.priceChild, amountDays)
