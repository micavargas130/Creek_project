...
const New = () => {
  ...
  const [numberOfAdults, setNumberOfAdults] = 0;
  const [numberOfChildren, setNumberOfChildren] = 0;
  ...
  const confirmFinishClick = async () => {
    ...
    try {
        const tentResponse = await axiosInstance.post("http://localhost:3000/tents", {
            first_name,
            last_name,
            dni,
            email,
  ...
  <div className="modal">
    <div className="modalContent">
      ...
      <h2>Total a pagar: {((numberOfAdults * price.priceAdult) + (numberOfChildren * price.priceChild))* amountDays} </h2>
      ...
      {selectedStatus === "parcial" && (
          ...
          <input
            ...
            onChange={(e) => {
              ...
              const totalToPay = ((numberOfAdults * price.priceAdult) + (numberOfChildren * price.priceChild)) * amountDays;
              if (value > totalToPay) {
