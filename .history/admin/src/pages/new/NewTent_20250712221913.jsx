          ...
          <div className="right">
            ...
            <div className="mb-64">
                  <div>
                    ...
                    <div>
                      Check-In
                      <input type="date" placeholder="check-in" value={checkIn}  min={checkIn || moment().format("DD-MM-YYYY")}onChange={(ev) => setCheckIn(ev.target.value)} />
                      Check-Out
                      <input type={"date"} placeholder="check-out" value={checkOut} onChange={(ev) => setCheckOut(ev.target.value)} />
                      Cantidad de adultos
                      <input type="number" placeholder="Cantidad de adultos" value={numberOfAdults} onChange={(ev) => {
                      ...
                      />
                      Cantidad de niños
                      <input type="number" placeholder="Cantidad de niños" value={numberOfChildren} onChange={(ev) => {
