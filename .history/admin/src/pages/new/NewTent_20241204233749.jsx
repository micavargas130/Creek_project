...
const New = () => {
  ...
  const confirmFinishClick = async () => {
    ...
    try {
     ...
     if (selectedStatus === "pagada") {
       payment = tentResponse.data.price; // Pago completo
       ...
       console.log("info1", partialPayment)
       console.log("info2", tentResponse.data.price)
       console.log("info3", partialPayment - payment)
       console.log("info4", selectedStatus)
 

      const paymentData = {
        amount: payment, //lo que pago el cliente
        totalAmount: tentResponse.data.price, //lo que debe pagar
        type: "Ingreso",
        date: new Date().toISOString(),
        tent: tentId,
        remainingAmount: (tentResponse.data.price - partialPayment),
  ...
  <div className="modal">
    <div className="modalContent">
      ...
      <h2>Total a pagar: {(numberOfAdults * price.priceAdult) + (numberOfChildren * price.priceChild)} </h2>
