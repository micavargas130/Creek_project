          ...
          <div className="right">
            <form onSubmit={confirmFinishClick}>
              <div className="mb-64">
                ...
                <div>
                  <label>Check-In</label>  <input type="date" value={checkIn} min={moment().format("DD-MM-YYYY")} onChange={(e) => setCheckIn(e.target.value)} />
                </div>
                <div>
                  <label>Check-Out</label> <input type="date" value={checkOut} min={checkIn || moment().format("DD-MM-YYYY")}  onChange={(e) => setCheckOut(e.target.value)} />
                </div>
                <div>
