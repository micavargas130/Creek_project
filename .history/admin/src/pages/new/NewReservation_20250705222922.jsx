          ...
          <div className="right">
            <form onSubmit={confirmFinishClick}>
              <div className="mb-64">
                ...
                <div>
                  <label>Check-In</label>  <input type="date" value={checkIn}  min="0" onChange={(e) => setCheckIn(e.target.value)} />
                </div>
                <div>
                  <label>Check-Out</label> <input type="date" value={checkOut}  min="0" onChange={(e) => setCheckOut(e.target.value)} />
                </div>
                <div>
