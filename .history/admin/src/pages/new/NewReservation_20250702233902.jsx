      ...
      try {
         ...
         if (checkIn && checkOut) {
           try {
             ...
             console.error("Error al obtener cabañas disponibles:", err);
           }
         } else {
          ...
          <div className="right">
            <form onSubmit={confirmFinishClick}>
              <div className="mb-64">
                ...
                <div>
                  <label>Check-In</label> <input type="date" value={checkIn} onChange={(e) => setCheckOut(e.target.value)} />
                </div>
                <div>
                  <label>Check-Out</label> <input type="date" value={checkOut}  />
                </div>
                <div>
                  <label>Email</label>
                  <input
