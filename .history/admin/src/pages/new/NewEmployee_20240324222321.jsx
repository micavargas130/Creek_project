    ...
    <div className="new">
      ...
      <div className="newContainer">
        ...
        <div className ="mb-64">
          ...
          Email <input type="text" placeholder="Email" value={email} onChange={ev => setEmail(ev.target.value)}/>
          Salario Base <input type="Number" placeholder="Salario Base" value={base_salary} onChange={ev => setEmail(ev.target.value)}/>
          Email <input type="text" placeholder="Email" value={email} onChange={ev => setEmail(ev.target.value)}/>
          Email <input type="text" placeholder="Email" value={email} onChange={ev => setEmail(ev.target.value)}/>
          </div>
