    ...
    const fetchPricesData = async () => {
      try {
        const [cabanasRes, carpasRes] = await Promise.all([
          axios.get(`/prices/66f8b88d5e41d6ee37542fca`), // Precios de cabañas
            ...
            <div className="lodgeWrapper">
              <div className="lodgeDetails">
                <div className="lodgeDetailsTexts">
                  {/* Precios de Cabañas */}
                  <h2 className="sectionTitle highlight">Precios de Cabañas</h2>
                  ...
                  {/* Precios de Carpas */}
                  <h2 className="sectionTitle highlight">Precios de Carpas</h2>
                  <h1 className="lodgeMinititle">Precio Adulto</h1>
                  <p className="lodgeDesc">
                    {editing ? (
                      <input
