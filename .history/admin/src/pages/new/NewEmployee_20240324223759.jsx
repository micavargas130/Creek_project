...
Para limitar el campo DNI a 8 dígitos, puedes utilizar la propiedad maxLength en el elemento de entrada input. Esto asegurará que el usuario no pueda ingresar más de 8 caracteres en el campo.

Aquí está cómo puedes aplicarlo a tu código:

jsx
Copy code
DNI <input type="number" placeholder="DNI" value={dni} onChange={ev => setDni(ev.target.value)} maxLength={8} />
