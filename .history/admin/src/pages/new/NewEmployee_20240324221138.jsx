    ...
    <div className="new">
      ...
      <div className="newContainer">
        ...
        <div className ="mb-64">
          ...
          <div> 
          Nombre <input type="text" placeholder="Nombre" value={first_name} onChange={ev => setAmount(ev.target.value)}/> 
          Apellido <input type="number" placeholder="Monto" value={amount} onChange={ev => setAmount(ev.target.value)}/> 
