...
const New = () => {
  ...
  const handleDateChange = (checkOut) => {
    ...
    const daysDifference = Math.round((checkOutDate - checkInDate) / (1000 * 3600 * 24)); //diferencia de dias entre fecha check-in y check-out
          ...
          <div className="right">
            ...
            <div className="mb-64">
                  <div>
                    ...
                    <div>
                      Check-In
                      <input type="date" placeholder="check-in" value={checkIn}  min={moment().format("DD-MM-YYYY")} onChange={(ev) => setCheckIn(ev.target.value)} />
                      Check-Out
