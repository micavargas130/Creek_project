...
const New = () => {
  ...
  const confirmFinishClick = async () => {
    ...
    try {
      const tentResponse = await axios.post("http://localhost:3000/bookings/createBooking", {
        first_name,
        last_name,
        dni,
        email,
    ...
    <div className="new">
      ...
      <div className="newContainer">
        ...
        <div className="bottom">
          <div className="left">
            <Calendar lodgeId={lodgeId} />   {/* Actualizar el calendario basado en la cabaña seleccionada */}
          </div>
          <div className="right">
            <form onSubmit={comfirm}>
              <div className="mb-64">
                <div>
                  <div>
