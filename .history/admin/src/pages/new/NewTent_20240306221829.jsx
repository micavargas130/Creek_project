...
import rGrillIcon from '@mui/icons-material/OutdoorGrillOutlined';
                        ...
                        <div key={row} className="map-row">
                          {Array.from({ length: 10 }, (_, col) => (
                            ...
                            >
                              ...
                              {row >= 2 && col >=0 && col < 2  ? (
                                <HouseSidingRoundedIcon className="icon" />  //icono cabañas
                              ) : row === 5 && col === 2   ?  (
                                <OtherHousesIcon className="icon" />        //icono casa principal
                              ) : row >= 6 && col >=2  && col < 4  ? (
                                <PoolIcon className="icon" />               // icono pileta
                              ) : row >= 5 && col >=3  && col < 4  ? (
                                <RestaurantIcon className="icon" />         //icono restaurante
                              ):  row >= 3 && col >= 8   ? (
                                <GarageIcon className="icon" />             //icono garage
                              ):  row >= 3 && col >= 8   ? (
                                <GarageIcon className="icon" />             //icono parrilla
                              ): (
