    ...
    useEffect(() => {
      const fetchData = async () => {
        try {
          ...
          let res2;
          if (añoRanking === "mes" && fechaSeleccionada) {
            const [año, mes] = fechaSeleccionada.split("-");
            console.log("Llamando a /graphs/reservas-cabana con:", { añoRanking, año, mes });
            console.log("fecha", fechaSeleccionada)
            res2 = await axiosInstance.get("/graphs/reservas-cabana", {
              params: { añoRanking, año, mes }
            });
          } else {
            res2 = await axiosInstance.get("/graphs/reservas-cabana");
          }
      ...
      fetchData();
    }, [vista, fechaSeleccionada, añoRanking]);
