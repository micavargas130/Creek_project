...
useEffect(() => {
  const fetchData = async () => {
    try {
      const res1 = await axios.get("/graphs/reservas-tiempo");
      const res2 = await axios.get("/graphs/reservas-cabana");
      const res3 = await axios.get("/graphs/promedio-huespedes");
      const res4 = await axios.get("/graphs/promedio-estadia");
