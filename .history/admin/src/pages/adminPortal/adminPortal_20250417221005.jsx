import {
  ...
  import {  YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
        ...
        <Box sx={{ flexGrow: 1 }}>
          ...
          <Box sx={{ p: 3, display: 'grid', gap: 3, gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" } }}>
            ...
            <Paper sx={{ p: 2, textAlign: "center" }}>
              ...
              <Typography color="text.secondary">Cabañas: {promedioHuespedes.avgGuestsLodges?.toFixed(2)}</Typography>
              <Typography color="text.secondary">Carpas: {promedioHuespedes.avgGuestsTents?.toFixed(2)}</Typography>
            </Paper>
  
            {/* Promedio de estadía */}
            <Paper sx={{ p: 2, textAlign: "center" }}>
              <Typography variant="h6" gutterBottom>Duración Promedio de Estadía</Typography>
              <Typography color="text.secondary">Cabañas: {promedioEstadias.avgStayLodges?.toFixed(2)} días</Typography>
              <Typography color="text.secondary">Carpas: {promedioEstadias.avgStayTents?.toFixed(2)} días</Typography>
            </Paper>
          </Box>
        </Box>
      </Box>
