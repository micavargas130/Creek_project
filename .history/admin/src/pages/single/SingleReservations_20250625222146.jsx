      ...
      <div className="singleContainer">
        ...
        <div className="bottom">
         <div className="reservationInfoSection">
          ...
          <div className="detailItem">
            <span className="">Monto de la seña:</span>
