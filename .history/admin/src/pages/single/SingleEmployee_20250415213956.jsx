...
const Single = () => {
  ...
  const handleSelectEvent = async (event) => {
    console.log(event)
    const confirmDelete = window.confirm(`¿Seguro que quieres eliminar la tarea "${event.title}"? Esto eliminará todas las entradas desde ${event.start} hasta ${event.end}`);
    if (confirmDelete) {
      try {
