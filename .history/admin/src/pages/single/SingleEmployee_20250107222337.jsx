...
const Single = () => {
  ...
  const [editedIsEmployee, setEditedIsEmployee] = useState(false);
    ...
    if (employeeId) {
      axios
        ...
        .then((response) => {
          ...
          setEditedIsEmployee(response.data.isEmployee);
    ...
    <select
      ...
      onChange={(e) => {
        ...
        if (value === "admin") {
          ...
          setEditedIsEmployee(false); // Asegura que sea mutuamente excluyente
