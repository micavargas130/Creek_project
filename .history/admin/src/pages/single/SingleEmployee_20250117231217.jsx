...
import axiosInstance from "../../axios/axiosInstance.js"import "./singleEmployee.scss";
...
const Single = () => {
  ...
  useEffect(() => {
    if (employeeId) {
      axios.get(`/employees/${employeeId}`).then((response) => {
  ...
  const handleSaveClick = async () => {
    try {
      ...
      const userResponse = await axios.put(`/user/${userId}`, {
