  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      try {
        ...
        console.log("response", accountingData)
        console.log("booking", accountingData.booking._id);

        // Determina si es una carpa o una cabaña
        const entityType = accountingData.lodge ? "lodge" : "tent";
        const entityId = accountingData.lodge.lodge._id || accountingData;  //Id de la cabaña
        ...
        if (entityType === "lodge") {
         ...
         const bookingResponse = await axios.get(`/bookings/${accountingData.booking._id}`);
