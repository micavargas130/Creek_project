  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      try {
        ...
        const entityId = accountingData.lodge.lodge._id || accountingData.tent._id;
        ...
        if (entityType === "lodge") {
          ...
          const historyResponse = await axios.get(`http://localhost:3000/accounting/history/${accountingData._id}`);
