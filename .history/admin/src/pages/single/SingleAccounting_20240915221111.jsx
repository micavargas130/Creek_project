    ...
    const fetchBookingData = async () => {
      try {
       ...
       // setUser(userResponse.data);
        ...
        const lodgeResponse = await axios.get(`/tents/${lodgeId}`);
      ...
      <div className="singleContainer">
        ...
        <div className="top">
          <div className="left">
            ...
            <h1 className="item">{lodge.first_name} {lodge.last_name}</h1>
            <div className="item">
              <div className="details">
                <div className="detailItem">
                  <span className="itemKey">Email:</span>
                  <span className="itemValue">{lodge.email}</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Phone:</span>
                  <span className="itemValue">{lodge.phone}</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">DNI:</span>
                  <span className="itemValue">{lodge.dni}</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Ocupation:</span>
                  <span className="itemValue">{lodge.ocupation}</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">Birthday:</span>
                  <span className="itemValue">{lodge.birthday}</span>
                </div>
              </div>
            </div>
          </div>
