            ...
            <div className="reservationInfoSection">
              ...
              {entity.checkIn && (
                <div className="infoRow">
                  ...
                  <span className="value"><p><strong>Check-in:</strong> {item.checkIn.slice(0, 10).split("-").reverse().join("/")}</p>

<p><strong>Check-in:</strong> {item.checkOut.slice(0, 10).split("-").reverse().join("/")}</p></span>
                </div>
              )}
              {entity.checkOut && (
                <div className="infoRow">
                  <span className="label">Fecha de egreso:</span>
                  <span className="value">{new Date(entity.checkOut).toLocaleDateString()}</span>
                </div>
              )}
              <div className="infoRow">
