  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      try {
        ...
        console.log("accounting", accountingData.lodge)
       let entityId;
        ...
        if (entityType === "lodge") {
         ...
         const bookingResponse = await axiosInstance.get(`/bookings/${accountingData.lodge.lodge}`);
         ...
         setPaymentHistory(historyResponse.data);
          ...
          const tentResponse = await axiosInstance.get(`/tents/${accountingData.lodge}`);
          setEntity(tentResponse.data); 
          setUser(tentResponse.data);

          const historyResponse = await axiosInstance.get(`accounting/booking/${entityId}`);
          setPaymentHistory(historyResponse.data);      
        }
        setLoading(false);
      } catch (error) {
