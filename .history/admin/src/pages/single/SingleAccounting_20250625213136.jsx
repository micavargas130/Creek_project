  ...
  return (
    <div className="single">
      ...
      <div className="singleContainer">
       ...
       <h1 className="title">
         Información de la {accounting.lodge ? "cabaña" : "carpa"}
       </h1>
       ...
       {entity.checkIn && (
         <div className="detailItem">
           ...
           <span className="itemValue">
             {new Date(entity.checkIn).toLocaleDateString()}
           </span>
         </div>
       )}
       ...
       {entity.checkOut && (
         <div className="detailItem">
           ...
           <span className="itemValue">
             {new Date(entity.checkOut).toLocaleDateString()}
           </span>
         </div>
       )}
       ...
       <div className="detailItem">
         <span className="itemKey">Precio por Adulto:</span>
         <span className="itemValue">${prices.data.priceAdult}</span>
       </div>
       <div className="detailItem">
         <span className="itemKey">Precio por Niño:</span>
         <span className="itemValue">${prices.data.priceChild}</span>
       </div>
       ...
       {entity.totalAmount && (
         <>
           ...
           <div className="detailItem total">
             ...
             <span className="itemValue totalAmount">${entity.totalAmount}</span>
           </div>
         </>
       )}
     </div>
