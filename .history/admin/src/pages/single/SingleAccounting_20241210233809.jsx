  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      try {
        ...
        const entityType = accountingData.lodge ? "lodge" : accountingData.tent ? "tent" : null;
      if (!entityType) {
        throw new Error("Ni lodge ni tent están definidos en accountingData.");
      }
        const entityId = accountingData.lodge.lodge._id || accountingData.tent._id;  //Id de la cabaña

        console.log("entit23", entityType);
