...
const Single = () => {
  ...
  const handleSelectEvent = async (event) => {
    const confirmDelete = window.confirm(`¿Seguro que quieres eliminar la tarea "${event.title}"? Esto eliminará todas las entradas desde ${event.startDate} hasta ${event.endDate}`);
    if (confirmDelete) {
      try {
