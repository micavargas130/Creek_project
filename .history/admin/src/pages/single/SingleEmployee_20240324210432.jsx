  ...
  const handleSaveClick = async () => {
    try {
      const response = await axios.put(`/employees/${employee._id}`, {
        position: editedPosition || employee.position,
        status: editedStatus || employee.status,
        base_salary: editedBaseSalary || employee.base_salary,
        joining_date: editedJoiningDate || employee.joining_date,
      });
        ...
        <div className="top">
          <div className="left">
            <div className="editButton" onClick={handleEditClick}>
              ...
              {editMode && (
          <div className="editButton" onClick={handleSaveClick}>
            Save
          </div>
        )}
            </div>
