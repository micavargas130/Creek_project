...
const Single = () => {
  ...
  const [boking, setBooking] = useState({});
  ...
  useEffect(() => {
    const fetchBookingData = async () => {
      try {
        ...
        console.log("bookin", bookingData)
        ...
        const priceResponse = await axiosInstance.get(`/prices/cabañas/${booking.createdAt}`)
      ...
      <div className="singleContainer">
        ...
        <div className="bottom">
         <div className="reservationInfoSection">
          ...
          <div className="infoRow">
            <span className="label">Dia en que se registró la reserva:</span>
            <span className="value">{(booking.createdAt.slice(0, 10).split("-").reverse().join("/"))}</span>
          </div>
          <div className="infoRow">
