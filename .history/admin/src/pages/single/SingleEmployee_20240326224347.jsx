  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      const response = await axios.put(`/employees/${employeesId}`, {
        job: editedJob, // replace with the actual edited position
        ...
        start_date: editedStartDate, // replace with the actual edited joining date
      });
                ...
                <h2 className="detailItem">
                  ...
                  {editMode ? (
                    <Select
                      ...
                      value={{ value: editedStatus, label: editedStatus }}
                      onChange={(selectedOption) => setEditedStatus(selectedOption.e.value)}
                    />
                  ) : (
                    employee.status
                  )}
