...
const tentsRoute = require("./api/routes/tents.js");
const notificationsRoute = require("./api/routes/notifications.js");
const employeesRoute = require("./api/routes/employees.js");
const pricesRoute = require("./api/routes/prices.js");
const scheduleRoute = require("./api/routes/schedule.js");
const graphsRoute = require("./api/routes/graphs.js");
const lodge_x_statusRoute = require("./api/routes/lodge_x_status.js");
const lodgeRoute = require("./api/routes/lodges.js");
const bookingsRoute = require("./api/routes/bookings.js");
const accountingRoute = require("./api/routes/accounting.js");
