...
if (process.env.NODE_ENV !== 'test') {
  // En producción o desarrollo: conectar y luego levantar el servidor
  connect().then(() => {
    app.listen(PORT, () => {
  ...
  // En test: NO levantamos el servidor ni nos conectamos acá
  console.log("🧪 Modo test activado, no se levanta servidor desde index.js");
}
