  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p>Para confirmar la misma, necesitamos que envíes la seña correspondiente</p>
        <p>PDetalles de la cuenta</p>
        <ul>
          <li><strong>Monto a transferir (30% del monto de la reserva): </strong> ${bookingDetails.totalPrice}</li>
