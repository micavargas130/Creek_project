  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <br>
        <p>Puedes ingresar a <a href="https://creek-project.vercel.app/">https://creek-project.vercel.app/</a> con:</p>
        <ul>
  ...
  try {
    const mailOptions = {
      ...
      html: `
        ...
        <ul>
          <li><strong>Fecha de ingreso:</strong> ${bookingDetails.checkIn} a partir de las 10:00 AM</li>
          <li><strong>Fecha de salida:</strong> ${bookingDetails.checkOut}</li>
          <li><strong>Cabaña:</strong> ${bookingDetails.lodge.Name}</li>
          <li><strong>Precio Total:</strong> $${bookingDetails.totalPrice}</li>
        </ul>
        <p>Puedes ingresar a <a href="https://creek-project.vercel.app/">https://creek-project.vercel.app/</a> para ver mas detalles sobre tu reserva</p>
...
export const sendBookingWithDepositEmail = async (userEmail, userName, password, bookingDetails) => {
  try {
    const now = new Date();
    now.setDate(now.getDate() + 2); // suma 3 días
    const deadline = now.toLocaleDateString("es-AR");
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <p><strong>Importante:</strong> Si no se recibe la seña antes de las proximas 48 horas, la reserva será cancelada automáticamente.</p>
        <br>
