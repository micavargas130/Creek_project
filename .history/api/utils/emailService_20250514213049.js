...
export const sendBookingEmailwith = async (userEmail, userName, password, bookingDetails) => {
  try {
    const mailOptions = {
...
export const sendBookingEmail2 = async (userEmail, userName, password, bookingDetails) => {
  try {
    const mailOptions = {
      from: "Camping Arroyito <arroyitocamping@gmail.com>",
      to: userEmail,
...
export const sendBookingReminderEmail = async (userEmail, userName, password, bookingDetails) => {
  try {
    const now = new Date();
