    ...
    const mailOptions = {
      ...
      html: `
        ...
        <ul>
          ...
          <li><strong>CBU: 0002392456109234581993 </strong> ${userEmail}</li>
          <li><strong>Titular de la cuenta: Santander Rio </strong> ${userEmail}</li>
          <li><strong>Banco: Santander Rio</strong> ${userEmail}</li>
        </ul>
