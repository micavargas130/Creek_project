...
export const sendBookingEmail = async (userEmail, userName, password, bookingDetails) => {
  try {
    ...
    const mailOptions = {
      ...
      to: userEmail,
      subject: "Se registrde tu reserva - Camping Arroyito",
      html: `
        <h2>Hola, ${userName}!</h2>
        <p>Tu reserva ha sido registrada correctamente. Para confirmar la misma, necesitamos que envíes la seña correspondiente dentro de las próximas 72 horas (<strong>hasta el ${deadline}</strong>).</p>
        ...
        <p>Una vez que ingreses, recuerda cambiar tu contraseña desde tu perfil.</p>
