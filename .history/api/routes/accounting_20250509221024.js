...
import { createAccounting, getAccountings, getAccounting, paymentHistory, getPaymentHistoryByLodge, deleteAccounting, updatePaymentStatus, getAccountingByFilter, getAccountingByBooking, uploadReceipt } from '../controllers/accounting.js';
...
router.post( "/pay/receipt/:id", upload.array("receipts"),  uploadReceipt );
