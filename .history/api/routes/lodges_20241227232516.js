...
import { createLodge, deleteLodge, getLodge, setOcupado, uploadPhotos, getLodges, getOccupiedPositions, updateLodgesAvailability,deleteLodgesAvailability, updateLodge, deleteOccupiedBy, setDesocupada, setMantenimiento, setMantenimientoWithComment, eliminarComment } from "../controllers/lodge.js";
...
router.get("/lodges/${lodgeId}/occupied-dates", getOccupiedPositions);
