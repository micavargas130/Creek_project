...
import { createAccounting, getAccountings, getAccounting, paymentHistory, getPaymentHistoryByLodge, deleteAccounting, setComment, updatePaymentStatus, getAccountingByFilter } from '../controllers/accounting.js';
...
router.get('/filer', getAccountingByFilter);
