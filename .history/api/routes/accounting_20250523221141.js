...
import { createAccounting, getAccountings, getAccounting, paymentHistory, getPaymentHistoryByEntity, deleteAccounting, updatePaymentStatus, getAccountingByFilter, getAccountingByBooking, deleteReceipt, uploadReceipt } from '../controllers/accounting.js';
...
router.get('/history/:type/:bookingId', getPaymentHistoryByLodge);
