...
import { createAccounting, getAccountings, getAccounting, paymentHistory, getPaymentHistoryByLodge, deleteAccounting, setComment, updatePaymentStatus } from '../controllers/accounting.js';
...
router.get('/history/:accountingId', paymentHistory);
