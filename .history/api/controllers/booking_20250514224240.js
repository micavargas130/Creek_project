...
import { sendBookingEmailwithPass, sendCancellationEmail } from "../utils/emailService.js";
import User from "../models/User.js"; 
import Price from '../models/Prices.js';
import { sendBookingEmailwithPass } from "../utils/mails/sendBookingEmailwithPass.js";
import { sendBookingWithDepositEmail } from "../utils/mails/sendBookingWithDepositEmail.js";
...
export const createBooking = async (req, res, next) => {
  try {
    ...
    if (!pendingStatus) {
      return res.status(500).json({ error: 'El estado "Pendiente" no existe' });
    }
    ...
    if (sendEmail) {
      ...
      const emailData = {
        checkIn,
        checkOut,
        lodgeName: lodge.name || "Cabaña/Carpa",
        totalPrice,
      };
