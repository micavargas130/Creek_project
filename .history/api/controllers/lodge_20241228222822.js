...
import Booking from '../models/Status.js';
...
export const getOccupiedDates = async (lodgeId) => {
  const bookings = await Booking.find({
    lodge: lodgeId,
    status: 'Activa' // Asumiendo que 'confirmed' es el estado que indica reserva activa
  });
