...
export const login = async (req, res, next) => {
    try{
        ...
        const token = jwt.sign({id:user._id, email: user.email, password first_name: user.first_name, last_name: user.last_name, isEmployee: user.isEmployee, isAdmin: user.isAdmin}, process.env.JWT_KEY, {}, (err,token) =>{
            if(err) throw err; 
