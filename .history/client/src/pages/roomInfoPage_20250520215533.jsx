...
const totalStayPrice = totalPricePerNight * nights;
  ...
  <div className="priceRow">
    ...
    <span>{Math.ceil((new Date(localDates[0].endDate) - new Date(localDates[0].startDate)) / (1000 * 60 * 60 * 24))}</span>
  </div>
  <hr />
  <div className="priceRow total">
    <span>Total a pagar:</span>
    <span><strong>${totalPrice * Math.ceil((new Date(localDates[0].endDate) - new Date(localDates[0].startDate)) / (1000 * 60 * 60 * 24))}</strong></span>
  </div>
</div>
