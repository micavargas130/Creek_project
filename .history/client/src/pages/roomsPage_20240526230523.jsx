      ...
      <div className="listWrapper">
        <div className="roomWrapper">
          {filteredLodges.length === 0 ? (
            <div className="noRooms">  <h3>Oh no! No hay habitaciones disponibles. </h3>
              <h3>Igualmente tenemos lugar disponible para acampar!  </h3>
              <img src="src/assets/asador.jpg"  className="activity-image" />
              <img src="src/assets/campingspace.jpeg"  className="activity-image" />
              <img src="src/assets/asador.jpeg"  className="activity-image" />
              <img src="src/assets/carpas.jpeg"  className="activity-image" />
              <img src="src/assets/sauces.jpeg"  className="activity-image" />
              <h3>Te esperamos!  </h3>
