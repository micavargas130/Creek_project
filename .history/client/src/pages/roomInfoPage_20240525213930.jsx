...
const formattedStartDate = dates.length > 0 ? format(dates[0].startDate, "dd/MM/yyyy") : "";
const formattedEndDate = dates.length > 0 ? format(dates[0].endDate, "dd/MM/yyyy") : "";
  ...
  return (
    ...
    {openDate && <DateRange
              ...
              onChange={(item) => setAdditionalDate(item.selection)}
              moveRangeOnFirstSelection={false}
              ranges={[additionalDate]}
              className="additionalDate"
            />
          />}
              </div>
              <h2>People</h2>
