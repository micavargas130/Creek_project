    ...
    try {
      ...
      const filteredLodges = await Promise.all(
        allLodges.map(async (lodge) => {
          ...
          const hasEnoughCapacity = lodge.capacity >= totalPeople;
          return available && hasEnoughCapacity ? lodge : null;
        })
      );
          ...
          {loading ? (
            ...
            <div className="noRooms">
              ...
              <div className="activity-images">
                <img src="/images/campingspace.jpeg" className="activity-image" alt="Espacio para acampar" />
                <img src="/images/carpas.jpeg" className="activity-image" alt="Carpas" />
                <img src="/images/sauces.jpeg" className="activity-image" alt="Sauces" />
                <img src="/images/image.jpeg" className="activity-image" alt="Sauces" />
              </div>
              <h3>¡Te esperamos!</h3>
            </div>
          ) : (
