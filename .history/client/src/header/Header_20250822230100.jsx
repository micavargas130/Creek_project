...
export default function Header() {
  ...
  const handleClick = () => {
      ...
      setTimeout(() => navigate("/roomsPage", { state: { dates, options } }), 0); //uelve rápido.
 ...
 return (
  <header className="header">
    ...
    {/* Contenedor que agrupa el título y el buscador */}
    <div className="flex flex-col items-center w-full">
      <h2 className="text-xl font-bold text-primary mb-2">¡Reservá ahora!</h2>
