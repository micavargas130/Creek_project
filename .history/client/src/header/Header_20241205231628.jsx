...
export default function Header() {
  ...
  const handleClick = () => {
    ...
    // Usar history para cambiar la URL manualmente y forzar la actualización
    window.history.pushState({}, "", "/roomsPage");
    
    // Esto actualiza manualmente, pero aún despachas los datos
